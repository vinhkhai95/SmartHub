...
function power_onclick(power_mode){
	switch(power_mode){
		case 1:
			var elem1 = document.getElementById("power-on");
			elem1.classList.remove("btn-default");
			elem1.classList.add("btn-info");

			var elem2 = document.getElementById("power-off");
			elem2.classList.remove("btn-info");
			elem2.classList.add("btn-default");
			break;
		case 2:
			var elem1 = document.getElementById("power-off");
			elem1.classList.remove("btn-default");
			elem1.classList.add("btn-info");

			var elem2 = document.getElementById("power-on");
			elem2.classList.remove("btn-info");
			elem2.classList.add("btn-default");
			break;
	}
...
function learning_onclick(){
	var elem = document.getElementById("learning");
